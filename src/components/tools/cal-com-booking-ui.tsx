      ...
      <div className="space-y-4">
        ...
        <div className="flex gap-4">
          <button
            ...
            disabled={isLoading}
            className="cursor-pointer bg-teal-600 text-white px-4 py-2 rounded-md font-medium text-sm shadow-sm hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-150"
          >
            Confirm Booking
          </button>
          <button
            ...
            disabled={isLoading}
            className="cursor-pointer border border-gray-300 bg-white text-gray-700 px-4 py-2 rounded-md font-medium text-sm shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-150"
          >
            Cancel
          </button>
        </div>
